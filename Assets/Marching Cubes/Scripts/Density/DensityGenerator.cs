...
namespace MarchingCubes
{
    public abstract class DensityGenerator : ScriptableObject
    {
        ...
        public virtual void GeneratePoints(ComputeBuffer pointsBuffer, ComputeBuffer substancesBuffer, int pointsPerAxis, float vertexDistance, Chunk chunk)
        {
            ...
            densityCompute.SetBuffer(0, "substances", substancesBuffer);
